...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('photologue_photo', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='photos', to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.user'
        db.delete_column('photologue_photo', 'user_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 9, 21, 23, 8, 313034)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 9, 21, 23, 8, 312873)'}),
        ...
        'photologue.gallery': {
            ...
            'photos': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'photos'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['photologue.Photo']"}),
        ...
        'photologue.photo': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
            'title_slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50', 'db_index': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'photos'", 'to': "orm['auth.User']"}),
