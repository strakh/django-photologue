...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field watermarks on 'PhotoSize'
        db.create_table('photologue_photosize_watermarks', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('photosize', models.ForeignKey(orm['photologue.photosize'], null=False)),
            ('watermark', models.ForeignKey(orm['photologue.watermark'], null=False))
        ))
        db.create_unique('photologue_photosize_watermarks', ['photosize_id', 'watermark_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field watermarks on 'PhotoSize'
        db.delete_table('photologue_photosize_watermarks')
    ...
    models = {
        ...
        'photologue.photosize': {
            ...
            'watermarks': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'photo_sizes'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['photologue.Watermark']"}),
