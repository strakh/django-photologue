...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 9, 21, 24, 9, 589155)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 9, 21, 24, 9, 588744)'}),
        ...
        'photologue.photo': {
            ...
            'galleries': ('photologue.models.ManyToManyField_NoSyncdb', [], {'related_name': "'galleries'", 'to': "orm['photologue.Gallery']", 'db_table': "u'photologue_gallery_photos'", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
